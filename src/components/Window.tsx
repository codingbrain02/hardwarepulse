...
function Window({
  ...
  const handleUpdate = () => {
    ...
    window.location.href = '/HardwarePulse';
  };
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h2 className="text-lg font-semibold text-gray-900 mb-2">Critical Hardware Issue Detected</h2>
                </div>
              </div>
              ...
              <div className="space-y-3 text-sm text-gray-700">
                <p>
                  <span className="font-semibold">Alert:</span> Hardware monitoring expired on{' '}
                ...
                <div className="bg-red-50 border border-red-200 rounded p-3">
                  <p className="font-semibold text-red-800 mb-1">⚠️ Hardware Failure Risk</p>
                  <p className="text-red-700">
                    Your hardware is running without proper monitoring. Component failure may occur and 
                    all data could be lost in{' '}
                ...
                <p className="bg-sky-50 border border-sky-200 rounded p-3">
                  <span className="font-semibold text-sky-800">Required:</span>{' '}
                  <span className="text-sky-700">
                    Install HardwarePulse monitoring software to protect your components and prevent data loss.
                  </span>
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-gray-200">
                ...
                <p className="text-xs text-gray-500 text-center mt-3">
                  Free Download • Real-Time Monitoring • Hardware Protection
                </p>
              </div>
            </div>
          )}
